...
class AircraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aircraft" do
    assert_difference("Aircraft.count") do
      post aircrafts_url, params: { aircraft: { make: @aircraft.make, model: @aircraft.model, serial: @aircraft.serial, tail: @aircraft.tail, tt: @aircraft.tt, year: @aircraft.year } }
    end
  ...
  test "should update aircraft" do
    patch aircraft_url(@aircraft), params: { aircraft: { make: @aircraft.make, model: @aircraft.model, serial: @aircraft.serial, tail: @aircraft.tail, tt: @aircraft.tt, year: @aircraft.year } }
