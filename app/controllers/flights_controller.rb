class FlightsController < ApplicationController
  ...
  def import
    ...
    CsvImportService.new.call(params)

    redirect_to request.referer, notice: t(:import_started)
  end
  ...
  private
    ...
    def flight_params
      params.require(:flight).permit(:aircraft_id, :date, :from, :to, :oil, :fuel, :tach, :hobbs, :note)
    end
end
